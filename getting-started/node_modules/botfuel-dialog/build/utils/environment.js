...
var logger = require('logtown')('Environment');
var MissingCredentialsError = require('../errors/missing-credentials-error');

var BOTFUEL_ADAPTER = 'botfuel';
var MONGO_BRAIN = 'mongo';
var BOTFUEL_NLU = 'botfuel';
 ...
 * @returns {void}
 */
var checkCredentials = function checkCredentials(config) {
  var _process$env = process.env,
      BOTFUEL_APP_TOKEN = _process$env.BOTFUEL_APP_TOKEN,
      BOTFUEL_APP_ID = _process$env.BOTFUEL_APP_ID,
      BOTFUEL_APP_KEY = _process$env.BOTFUEL_APP_KEY;
  // Botfuel app token
  ...
  if (!BOTFUEL_APP_KEY) {
    ...
    var keyEndingChars = BOTFUEL_APP_KEY.slice(BOTFUEL_APP_KEY.length - 4);
    var obfuscatedKey = 'xxxx' + keyEndingChars;
