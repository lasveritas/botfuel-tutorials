...
var CancelView = function (_PromptView) {
  _inherits(CancelView, _PromptView);

  function CancelView() {
    _classCallCheck(this, CancelView);

    return _possibleConstructorReturn(this, (CancelView.__proto__ || Object.getPrototypeOf(CancelView)).apply(this, arguments));
  }

  _createClass(CancelView, [{
    key: 'render',
    value: function render(userMessage, _ref) {
      var matchedEntities = _ref.matchedEntities;

      var answer = matchedEntities.answer && matchedEntities.answer.values[0].value;
